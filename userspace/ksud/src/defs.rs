...
mod android {
    ...
    pub const UMOUNT_LIST_PATH: &str = concatcp!(WORKING_DIR, "umount_list");
    pub const BL_HIDE_ENABLE_FILE: &str = concatcp!(WORKING_DIR, ".bl_hide_enable");
    pub const UTS_SPOOF_CONFIG: &str = concatcp!(WORKING_DIR, "uts_spoof.conf");
