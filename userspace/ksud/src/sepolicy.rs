...
const fn cmd_expected_argc(cmd: u32) -> Option<usize> {
    match cmd {
        ...
        crate::xnsu_uapi::XNSU_SEPOLICY_CMD_TYPE_STATE
        | crate::xnsu_uapi::XNSU_SEPOLICY_CMD_ATTR => Some(1),
        crate::xnsu_uapi::XNSU_SEPOLICY_CMD_TYPE
        | crate::xnsu_uapi::XNSU_SEPOLICY_CMD_TYPE_ATTR => Some(2),
