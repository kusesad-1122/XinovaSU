...
const fn cmd_expected_argc(cmd: u32) -> Option<usize> {
    match cmd {
        ...
        crate::ksu_uapi::KSU_SEPOLICY_CMD_TYPE_STATE
        | crate::ksu_uapi::KSU_SEPOLICY_CMD_ATTR => Some(1),
        crate::ksu_uapi::KSU_SEPOLICY_CMD_TYPE
        | crate::ksu_uapi::KSU_SEPOLICY_CMD_TYPE_ATTR => Some(2),
