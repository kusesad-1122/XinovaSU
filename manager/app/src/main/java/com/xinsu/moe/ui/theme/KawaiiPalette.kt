...
val legacySelectableKawaiiPalettes: List<KawaiiPalette> = listOf(
    KawaiiPalette.None,
    KawaiiPalette.Sakura,
    KawaiiPalette.Mint,
    KawaiiPalette.Lavender,
    KawaiiPalette.Cyber,
    KawaiiPalette.Obsidian,
    KawaiiPalette.Mica,
    KawaiiPalette.Ember,
    KawaiiPalette.Jade,
    KawaiiPalette.SakuraVN,
    KawaiiPalette.Snow,
    KawaiiPalette.Moonlit,
)
