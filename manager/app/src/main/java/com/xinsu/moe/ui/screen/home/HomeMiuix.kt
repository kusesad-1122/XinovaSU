...
import com.xinsu.moe.ui.theme.cardOpacityFraction
            ...
            LazyColumn(
                ...
                item {
                    Column(
                        ...
                        LearnKernelSUCard(onOpenUrl = actions.onOpenUrl)
                    }
    ...
    Column {
        when {
            state.ksuVersion != null -> {
                ...
                val cardOpacity = cardOpacityFraction()
                ...
                Row(
                    ...
                    Card(
                        modifier = Modifier
                            .weight(1f)
                            .fillMaxHeight(),
                        colors = CardDefaults.defaultColors(color = workingCardColor.copy(alpha = cardOpacity)),
                        onClick = {
                            if (!state.isLateLoadMode) {
                    ...
                    Column(
                        ...
                        Card(
                            modifier = Modifier
                                .fillMaxWidth()
                                .weight(1f),
                            colors = CardDefaults.defaultColors(color = colorScheme.surface.copy(alpha = cardOpacity)),
...
private fun LearnMoreCard(
    ...
    Card(
        modifier = Modifier.fillMaxWidth(),
        colors = CardDefaults.defaultColors(color = colorScheme.surface.copy(alpha = cardOpacityFraction()))
    ) {
        BasicComponent(
