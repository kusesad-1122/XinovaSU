...
data class AppSettings(
    ...
    val themePreset: KawaiiPalette = KawaiiPalette.None,
)
...
object ThemeController {
    fun getAppSettings(context: Context): AppSettings {
        ...
        val themePreset = KawaiiPalette.fromName(prefs.getString("theme_preset", KawaiiPalette.None.name))

        return AppSettings(colorMode, keyColor, paletteStyle, colorSpec, themePreset)
    }
}
