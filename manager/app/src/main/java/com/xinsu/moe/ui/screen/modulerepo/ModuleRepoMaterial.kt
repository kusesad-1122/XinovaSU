...
import com.xinsu.moe.ui.component.material.SearchAppBar
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            PrimaryTabRow(
                ...
                containerColor = if (LocalBackgroundStyle.current.isActive) Color.Transparent else MaterialTheme.colorScheme.surface,
