...
import com.xinsu.moe.ui.viewmodel.ModuleRepoViewModel
import com.xinsu.moe.ui.viewmodel.ModuleViewModel
...
fun ModuleRepoDetailScreen(module: RepoModuleArg) {
    ...
    var webUrl by remember(module.moduleId) { mutableStateOf("https://modules.xinovasu.org/module/${module.moduleId}") }
    var sourceUrl by remember(module.moduleId) { mutableStateOf("https://github.com/XinovaSU-Modules-Repo/${module.moduleId}") }
