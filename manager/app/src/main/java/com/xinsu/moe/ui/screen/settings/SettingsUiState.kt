...
data class SettingsUiState(
    ...
    val themePreset: String = KawaiiPalette.None.name,
    val backgroundStyle: String = BackgroundStyle.None.name,
    val backgroundImageUri: String = "",
    val backgroundImageAlpha: Int = 100,
    val backgroundImageAlign: Int = 1,
    val cardImageUri: String = "",
    val cardImageAlpha: Int = 100,
    val cardImageAlign: Int = 1,
    val cardOpacity: Int = 100,
    val homeCardOrder: String = "",
    val homeCardShapes: String = "",
    val cardsGlass: Boolean = false,
