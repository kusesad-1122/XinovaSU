...
interface SettingsRepository {
    ...
    var backgroundImageAlpha: Int
    var backgroundImageAlign: Int
    var cardImageUri: String
    var cardImageAlpha: Int
    var cardImageAlign: Int
    var cardOpacity: Int
    var homeCardOrder: String
    var homeCardShapes: String
    var cardsGlass: Boolean
