...
import com.xinsu.moe.data.model.TemplateInfo
...
import com.xinsu.moe.ui.util.setAppProfileTemplate
...
class TemplateRepositoryImpl : TemplateRepository {
    ...
    companion object {
        ...
        private const val TEMPLATE_INDEX_URL = "https://xinovasu.org/templates/index.json"
        private const val TEMPLATE_URL = "https://xinovasu.org/templates/%s"
    }
