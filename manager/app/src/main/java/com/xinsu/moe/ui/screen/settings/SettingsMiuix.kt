...
import com.xinsu.moe.ui.component.dialog.rememberLoadingDialog
import com.xinsu.moe.ui.component.miuix.SendLogDialog
                ...
                item {
                    ...
                    KsuIsValid {
                        MiuixGlassCard(
                            ...
                            ArrowPreference(
                                title = functions,
                                summary = stringResource(id = R.string.functions_summary),
                                startAction = {
                                    Icon(
                                        Icons.Rounded.Tune,
                                        modifier = Modifier.padding(end = 6.dp),
