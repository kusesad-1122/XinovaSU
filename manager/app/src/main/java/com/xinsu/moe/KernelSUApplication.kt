...
lateinit var ksuApp: XinovaSUApplication

class XinovaSUApplication : Application(), ViewModelStoreOwner {
                ...
                .addInterceptor { block ->
                    block.proceed(
                        block.request().newBuilder()
                            .header("User-Agent", "XinovaSU/${BuildConfig.VERSION_CODE}")
