package com.xinsu.moe.ui.screen.settings
...
import com.xinsu.moe.ui.theme.transparentChromeColor
...
import com.xinsu.moe.ui.component.material.SendLogBottomSheet
import com.xinsu.moe.ui.component.material.SnackBarHost
import com.xinsu.moe.ui.component.uninstalldialog.UninstallDialog
...
fun SettingPagerMaterial(
    ...
    Scaffold(
        ...
        Column(
            ...
            val functions = stringResource(id = R.string.functions)
            KsuIsValid {
                SegmentedColumn(
                    modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                    content = listOf {
                        SegmentedListItem(
                            ...
                            headlineContent = { Text(functions) },
                            supportingContent = { Text(stringResource(id = R.string.functions_summary)) },
                            leadingContent = { Icon(Icons.Filled.Tune, functions) },
                            trailingContent = {
                                Icon(
                                    Icons.AutoMirrored.Filled.KeyboardArrowRight,
                                    null
...
private fun TopBar(
    ...
    val chromeColor = transparentChromeColor(MaterialTheme.colorScheme.surface)
