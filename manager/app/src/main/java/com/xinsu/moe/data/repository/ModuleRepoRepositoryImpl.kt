...
import com.xinsu.moe.data.model.Author
import com.xinsu.moe.data.model.ReleaseAsset
...
class ModuleRepoRepositoryImpl : ModuleRepoRepository {
    ...
    companion object {
        private const val MODULES_URL = "https://modules.xinovasu.org/modules.json"
    }
