package com.xinsu.moe.ui.screen.about
...
import com.xinsu.moe.ui.component.miuix.effect.BgEffectBackground
import com.xinsu.moe.ui.component.miuix.effect.ColorBlendToken
...
fun AboutScreenMiuix(
    ...
    val barColor = if (blurActive || LocalBackgroundStyle.current.isActive) {
        Color.Transparent
    } else {
            ...
            item(key = "about") {
                Column(
                    ...
                    MiuixGlassCard(
                        ...
                        containerColor = if (enableBlur) Color.Transparent else null,
