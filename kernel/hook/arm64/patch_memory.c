...
#define xnsu_flush_icache(start, end) caches_clean_inval_pou
#else
#define xnsu_flush_dcache(start, sz) __flush_dcache_area((void *)start, sz)
#define xnsu_flush_icache(start, end) __flush_icache_range
#endif
