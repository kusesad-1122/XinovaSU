#ifndef XNSU_EVENT_QUEUE_H
#define XNSU_EVENT_QUEUE_H
...
#define XNSU_EVENT_RECORD_FLAG_INTERNAL (1U << 0)
#define XNSU_EVENT_QUEUE_TYPE_DROPPED ((__u16)0xFFFF)

struct xnsu_event_record_hdr {
    __u16 type;
    __u16 flags;
    __u32 len;
    __u64 seq;
...
struct xnsu_event_queue_dropped_info {
    __u64 dropped;
    __u64 first_seq;
    __u64 last_seq;
};
